      ...
      (window.onmousemove = function (s) {
        if ($window.width() > 1440) {
          o ||
            (t.style.transform =
              "translate(" +
              (s.clientX * 1440) / $window.width() +
              "px, " +
              (s.clientY * 1440) / $window.width() +
              "px)"),
            (e.style.transform =
              "translate(" +
              (s.clientX * 1440) / $window.width() +
              ...
              (s.clientY * 1440) / $window.width() +
              "px)"),
            (n = (s.clientY * 1440) / $window.width()),
            (i = (s.clientX * 1440) / $window.width());
        } else {
          o ||
            (t.style.transform =
        ...
        $("body").on("mouseleave", "a, .cursor-pointer, button", function () {
          ($(this).is("a") && $(this).closest(".cursor-pointer").length) ||
            (e.classList.remove("mmc-hover"), t.classList.remove("mmc-hover"));
        }),
